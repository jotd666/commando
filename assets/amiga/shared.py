...
0x2E2,
0x1F8,0x246,0x278,
0x2FA,0x2FC,0xC9,0xC2,0x204,0x206,0x70,0x92,0x1A,0x1D,0x166,0x8,0x16E,0x19A,0x48,
0x168,0x30,0x38,0x10,0x15A,0x1F2,0x1FA,0X232,0x234,0x238,
0x178,0x164,0x170,0x172
}
...
a lot don't need it, but soldiers do

"""
    rval = ({0xA1,0xA2,0xA3,0xF6,0xF7} |   # snipers behind bunkers
    set(range(0x40,0x70))  |  # covers most soldiers
    {0xA4,0xAB} |
    set(range(0xDB,0xE0))  # mortar
    )
    return rval
