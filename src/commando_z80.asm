...
0624: F7          rst  $30    ; [jump_to_jump_table] [nb_entries=12]
; jump_table_0625:
	dc.w	$0646	; $0625
	dc.w	$06dd	; $0627
	dc.w	$0769	; $0629
...
1E96: F7          rst  $30    ; [jump_to_jump_table] [nb_entries=9]
; jump_table_1e97:
	dc.w	$1eee	; $1e97
	dc.w	$1f0b	; $1e99
	dc.w	$1f17	; $1e9b
...
2A72: F7          rst  $30    ; [jump_to_jump_table] [nb_entries=49]
; jump_table_2a73:
	dc.w	$1bb3	; $2a73
	dc.w	$1cf4	; $2a75
	dc.w	$1d63	; $2a77
...
30C6: 1E F6       ld   e,$7E
30C8: 00          nop
30C9: F7          rst  $30    ; [jump_to_jump_table] [nb_entries=8]
; jump_table_30ca:
	dc.w	$b001	; $30ca
	dc.w	$6700	; $30cc
	dc.w	$b002	; $30ce
...
3798: 00          nop
3799: F6 10       or   $10
379B: F7          rst  $30    ; [jump_to_jump_table] [nb_entries=20]
; jump_table_379c:
	dc.w	$5005	; $379c
	dc.w	$7501	; $379e
	dc.w	$7711	; $37a0
...
8B77: DC 00 0C    call c,system_c000
8B7A: 00          nop
8B7B: 00          nop
8B7C: 00          nop
8B7D: 00          nop
